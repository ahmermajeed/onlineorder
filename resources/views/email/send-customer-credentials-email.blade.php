                        ...
                        >
                                ...
                                >
                                    <a
                                        ...
                                        ><img
                                            ...
                                            width="200"
                                            alt="Logo"
                                            style="width:80%;max-width:235px;height:auto;border:none;text-decoration:none;color:#ffffff;"
                                    /></a>
                                </td>
                            </tr>
                            <!-- <tr>
                                        ...
                                        <div class="reservation-details">
                                           <ul>
                                               ...
                                               <li>
                                                ...
                                                <li>
                                                    <span><strong>Login Email:</strong></span>
                                                    <span>{{ $data['email'] }}</span>
                                                </li>
                                                <li>
                                                    <span><strong>Login Password:</strong></span>
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    >
                                        &reg; info@sentinal-e-pos.co, Sentinal-e-pos
                                        2021<br /><a
                                            class="unsub"
                                            href="javascript:;"
                                            style="color:#cccccc;text-decoration:underline; color: #fff;"
                                        >
                                            Copyright@sentinal-e-pos, All Right
                                            Reserved.</a
                                        >
                                    </p>
                                </td>
