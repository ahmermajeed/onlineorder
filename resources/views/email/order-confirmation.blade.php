                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t es-p20b" align="left">
                                                                <p style="font-size: 20px; color: #777777;">Your Order has been Placed. Our Team will contact you soon.<br></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p10b es-p10r es-p10l" align="left">
                                                                <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                    ...
                                                                    <?php  foreach ($data['order_details'] as $key => $v) {?>
                                                                    <tr>
                                                                        <td style="padding: 5px 10px 5px 0" width="80%" align="left">
                                                                            <p><?php echo $v['product_name'] ?>  (<?php echo  $v['quantity'] ?>)</p>
                                                                        </td>
                                                            ...
                                                            <td class="esd-block-text es-p15t es-p15b es-p10r es-p10l" align="left">
                                                                <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="20%">
                                                                            <h4>£ <?php echo $data['discounted_amount'] ?></h4>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="20%">
                                                                            <h4>£ <?php echo $data['total_amount_with_fee'] ?></h4>
                                                                        </td>
                                                                    </tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10b" align="left">
                                                                <p><?php echo $data['user_data']['address'] ?></p>
                                                                <p><?php echo $data['user_data']['street'] ?>, <?php echo $data['user_data']['postal_code'] ?></p>
                                                                <p><?php echo $data['user_data']['postal_code'] ?></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
