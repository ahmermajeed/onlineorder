                                ...
                                <div class="add-info">
                                    <ul>
                                         <li class="mail-space"><i class="icon-mail-2"></i>
                                            <span>
                                                <a href="mailto:info@tasty-land.com">info@sentinelepos.co.uk</a>
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                                <div class="col-md-12 item-row scroll style-3">
                                                                    <div class="row selected-item-row" v-for="(cart, product_index) in cartItems">
                                                                        <div class="col-md-8">
                                                                            <div class="item-list">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="edit-options">
                                                                                <span class="remove-item mr-2"  v-b-tooltip.hover title="remove" @click.prevent="removeFromCart(cart)"><i class="fa fa-times"></i></span>
                                                                    ...
                                                                    <p v-if="cartItems.length == 0" class="empty-cart">No item in cart</p>
                                                                </div>

                                                        </div>
                                                        <div class="view-total-menu">
                                                            <div class="col-md-12">
                                                                <div class="total"><strong>Total: </strong>£{{priceFormat(totalPrice)}}</div>
