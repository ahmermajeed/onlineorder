<template>
    <div>
        <b-modal 
            ...
            <h4 style="text-align:center">Choose your order type</h4>
             ...
             <div class="row postal-code-details">
                 <form>
                     <div class="form-group" v-if="showPostal">
                         ...
                         <input type="text"  class="form-control mb-3" v-model="postal_code" placeholder="Enter your Postcode">
                     </div>

                     <button type="button" class="btn btn-outline-success" v-on:click="checkPostCode">
