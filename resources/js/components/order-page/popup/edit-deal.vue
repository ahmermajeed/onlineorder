<template>
    <div>
        <b-modal id="add-deal" centered @hidden="onHidden" ok-only :ok-title="'Update to Order £ '+priceFormat(total_amount_of_single_product * product_quantity)" @ok="addToCart()"  title-tag="h4" ok-variant="primary" ref="myModalRef" custom-modal no-close-on-backdrop modal-class="custom-modal order-product custom-btm-popup">
