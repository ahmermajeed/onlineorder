                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-lg-4">
                                    <div class="contact-info-box">
                                        ...
                                        <p itemprop="description">Phone 0121 337 7378</p>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-lg-4">
                                    <div class="contact-info-box">
                                        ...
                                        <p itemprop="description">223-225 Edward Road, Birmingham, B12 9Lh.</p>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-lg-4">
                                    <div class="contact-info-box">
                                        ...
                                        <p itemprop="description"> info@thedessertking.co.uk</p>
                                    </div>
                                </div>
                            </div>

                        </div>
                        <div class="col-md-12 contactus-form">
                            <h2>Contact Us</h2>
                            <form action="">
                                <div class="row">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Comment" rows="5" required></textarea>
                                        </div>
                                    </div>

                                    <div class="col-12 text-right">
                                        <button class="anima-btn move-eff" type="submit">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="footer mt-0">
                        <div class="row">
                            <div class="col-md-5 footer-left">
                                <p>&copy; 2021 <span>All rights reserved</span></p>
                            ...
                            <div class="col-md-5 footer-right">
                                <p><span>Email:</span> <a href="#">info@thedessertking.co.uk</a></p>
                                <p><span>Phone:</span> 0121 337 7378</p>
