                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 px-0">
                        <div class="rating-content">
                            ...
                            <div class="located-num">
                                <strong>0208 6698 448</strong>
                                <p>15 Ross Parade, Wallington, SM6 8QG</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="menu-content">
                                        <div class="row">
                                            ...
                                            <div class="col-2 text-right">
                                                <span class="badge badge-pill badge-primary">Single</span>
                                            </div>
                                          </div>
                                    </div>
                                    <div class="menu-item">
